...
Im Vergleich zum ersten Experiment zeigt Experiment 2 über den gesamten ML- und Trading-Workflow hinweg klare Fortschritte: Durch die Umstellung auf Minutendaten, die angepasste Target-Definition (30-Minuten-Horizont) und die überarbeitete Feature-Auswahl verbessert sich die Modellqualität im Training und insbesondere im Testing deutlich (u. a. höhere Accuracy/F1/Recall), und das Modell sagt nun alle drei Klassen (UP, DOWN, NEUTRAL) aktiv voraus, während Experiment 1 den Down-Trend kaum erkennen konnte. Diese verbesserte Vorhersagefähigkeit spiegelt sich auch im Deployment wider: Im Backtesting erzielt Experiment 1 zwar eine positive Rendite, bleibt jedoch hinter Buy-and-Hold zurück, während Experiment 2 in einem stark fallenden Markt trotz leichter Verluste deutlich besser als Buy-and-Hold abschneidet und damit eher einen defensiven, verlustbegrenzenden Charakter zeigt. Im Paper Trading wird der Unterschied in der Stabilität besonders sichtbar: Experiment 1 scheitert aufgrund einer fehlerhaften Handelslogik (fortlaufende Buy-Orders ohne Sell-Ausführung) sehr schnell, während Experiment 2 über mehrere Tage lauffähig bleibt und regelmäßig Buy- sowie Sell-Orders ausführt. Dennoch liefern die Paper-Trading-Ergebnisse keine positive Performance: Die Equity fällt im betrachteten Zeitraum stärker als der Bitcoin-Preis, sodass der Bot aktuell keinen Vorteil gegenüber einer einfachen Buy-and-Hold-Strategie bietet. Insgesamt ist Experiment 2 methodisch und operativ klar überlegen, benötigt aber weitere Verbesserungen in Signalqualität und Risikologik, um auch unter Live-Bedingungen konsistent Mehrwert zu erzeugen.
